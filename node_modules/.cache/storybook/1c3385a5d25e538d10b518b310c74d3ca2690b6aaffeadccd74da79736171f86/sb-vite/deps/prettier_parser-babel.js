  ...
  "node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var Hs = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Ws = (a, t) => {
        ...
        if (t && typeof t == "object" || typeof t == "function") for (let i of qs(t)) !Ks.call(a, i) && i !== e && Se(a, i, { get: () => t[i], enumerable: !(s = Vs(t, i)) || s.enumerable });
        return a;
      };
      var vt = (a, t, e) => (e = a != null ? $s(zs(a)) : {}, kt(t || !a || !a.__esModule ? Se(e, "default", { value: a, enumerable: true }) : e, a)), Js = (a) => kt(Se({}, "__esModule", { value: true }), a);
      var At = Hs((xe) => {
        "use strict";
...
- Did you mean \`import { "${a}" as foo }\`?`, ImportCallArgumentTrailingComma: "Trailing comma is disallowed inside import(...) arguments.", ImportCallArity: ({ maxArgumentCount: a }) => `\`import()\` requires exactly ${a === 1 ? "one argument" : "one or two arguments"}.`, ImportCallNotNewExpression: "Cannot use new with import(...).", ImportCallSpreadArgument: "`...` is not allowed in `import()`.", ImportJSONBindingNotDefault: "A JSON module can only be imported with `default`.", ImportReflectionHasAssertion: "`import module x` cannot have assertions.", ImportReflectionNotBinding: 'Only `import module x from "./module"` is valid.', IncompatibleRegExpUVFlags: "The 'u' and 'v' regular expression flags cannot be enabled at the same time.", InvalidBigIntLiteral: "Invalid BigIntLiteral.", InvalidCodePoint: "Code point out of bounds.", InvalidCoverInitializedName: "Invalid shorthand property initializer.", InvalidDecimal: "Invalid decimal.", InvalidDigit: ({ radix: a }) => `Expected number in radix ${a}.`, InvalidEscapeSequence: "Bad character escape sequence.", InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.", InvalidEscapedReservedWord: ({ reservedWord: a }) => `Escape sequence in keyword ${a}.`, InvalidIdentifier: ({ identifierName: a }) => `Invalid identifier ${a}.`, InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Ee(a)}.`, InvalidLhsBinding: ({ ancestor: a }) => `Binding invalid left-hand side in ${Ee(a)}.`, InvalidLhsOptionalChaining: ({ ancestor: a }) => `Invalid optional chaining in the left-hand side of ${Ee(a)}.`, InvalidNumber: "Invalid number.", InvalidOrMissingExponent: "Floating-point numbers require a valid exponent after the 'e'.", InvalidOrUnexpectedToken: ({ unexpected: a }) => `Unexpected character '${a}'.`, InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.", InvalidPrivateFieldResolution: ({ identifierName: a }) => `Private name #${a} is not defined.`, InvalidPropertyBindingPattern: "Binding member expression.", InvalidRecordProperty: "Only properties and spread elements are allowed in record definitions.", InvalidRestAssignmentPattern: "Invalid rest operator's argument.", LabelRedeclaration: ({ labelName: a }) => `Label '${a}' is already declared.`, LetInLexicalBinding: "'let' is disallowed as a lexically bound name.", LineTerminatorBeforeArrow: "No line break is allowed before '=>'.", MalformedRegExpFlags: "Invalid regular expression flag.", MissingClassName: "A class name is required.", MissingEqInAssignment: "Only '=' operator can be used for specifying default value.", MissingSemicolon: "Missing semicolon.", MissingPlugin: ({ missingPlugin: a }) => `This experimental syntax requires enabling the parser plugin: ${a.map((t) => JSON.stringify(t)).join(", ")}.`, MissingOneOfPlugins: ({ missingPlugin: a }) => `This experimental syntax requires enabling one of the following parser plugin(s): ${a.map((t) => JSON.stringify(t)).join(", ")}.`, MissingUnicodeEscape: "Expecting Unicode escape sequence \\uXXXX.", MixingCoalesceWithLogical: "Nullish coalescing operator(??) requires parens when mixing with logical operators.", ModuleAttributeDifferentFromType: "The only accepted module attribute is `type`.", ModuleAttributeInvalidValue: "Only string literals are allowed as module attribute values.", ModuleAttributesWithDuplicateKeys: ({ key: a }) => `Duplicate key "${a}" is not allowed in module attributes.`, ModuleExportNameHasLoneSurrogate: ({ surrogateCharCode: a }) => `An export name cannot include a lone surrogate, found '\\u${a.toString(16)}'.`, ModuleExportUndefined: ({ localName: a }) => `Export '${a}' is not defined.`, MultipleDefaultsInSwitch: "Multiple default clauses.", NewlineAfterThrow: "Illegal newline after throw.", NoCatchOrFinally: "Missing catch or finally clause.", NumberIdentifier: "Identifier directly after number.", NumericSeparatorInEscapeSequence: "Numeric separators are not allowed inside unicode escape sequences or hex escape sequences.", ObsoleteAwaitStar: "'await*' has been removed from the async functions proposal. Use Promise.all() instead.", OptionalChainingNoNew: "Constructors in/after an Optional Chain are not allowed.", OptionalChainingNoTemplate: "Tagged Template Literals are not allowed in optionalChain.", OverrideOnConstructor: "'override' modifier cannot appear on a constructor declaration.", ParamDupe: "Argument name clash.", PatternHasAccessor: "Object pattern can't contain getter or setter.", PatternHasMethod: "Object pattern can't contain methods.", PrivateInExpectedIn: ({ identifierName: a }) => `Private names are only allowed in property accesses (\`obj.#${a}\`) or in \`in\` expressions (\`#${a} in obj\`).`, PrivateNameRedeclaration: ({ identifierName: a }) => `Duplicate private name #${a}.`, RecordExpressionBarIncorrectEndSyntaxType: "Record expressions ending with '|}' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionBarIncorrectStartSyntaxType: "Record expressions starting with '{|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionHashIncorrectStartSyntaxType: "Record expressions starting with '#{' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", RecordNoProto: "'__proto__' is not allowed in Record expressions.", RestTrailingComma: "Unexpected trailing comma after rest element.", SloppyFunction: "In non-strict mode code, functions can only be declared at top level or inside a block.", SloppyFunctionAnnexB: "In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement.", SourcePhaseImportRequiresDefault: 'Only `import source x from "./module"` is valid.', StaticPrototype: "Classes may not have static property named prototype.", SuperNotAllowed: "`super()` is only valid inside a class constructor of a subclass. Maybe a typo in the method name ('constructor') or not extending another class?", SuperPrivateField: "Private fields can't be accessed on super.", TrailingDecorator: "Decorators must be attached to a class element.", TupleExpressionBarIncorrectEndSyntaxType: "Tuple expressions ending with '|]' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionBarIncorrectStartSyntaxType: "Tuple expressions starting with '[|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionHashIncorrectStartSyntaxType: "Tuple expressions starting with '#[' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", UnexpectedArgumentPlaceholder: "Unexpected argument placeholder.", UnexpectedAwaitAfterPipelineBody: 'Unexpected "await" after pipeline body; await must have parentheses in minimal proposal.', UnexpectedDigitAfterHash: "Unexpected digit after hash token.", UnexpectedImportExport: "'import' and 'export' may only appear at the top level.", UnexpectedKeyword: ({ keyword: a }) => `Unexpected keyword '${a}'.`, UnexpectedLeadingDecorator: "Leading decorators must be attached to a class declaration.", UnexpectedLexicalDeclaration: "Lexical declaration cannot appear in a single-statement context.", UnexpectedNewTarget: "`new.target` can only be used in functions or class properties.", UnexpectedNumericSeparator: "A numeric separator is only allowed between two digits.", UnexpectedPrivateField: "Unexpected private name.", UnexpectedReservedWord: ({ reservedWord: a }) => `Unexpected reserved word '${a}'.`, UnexpectedSuper: "'super' is only allowed in object methods and classes.", UnexpectedToken: ({ expected: a, unexpected: t }) => `Unexpected token${t ? ` '${t}'.` : ""}${a ? `, expected "${a}"` : ""}`, UnexpectedTokenUnaryExponentiation: "Illegal expression. Wrap left hand side or entire exponentiation in parentheses.", UnexpectedUsingDeclaration: "Using declaration cannot appear in the top level when source type is `script`.", UnsupportedBind: "Binding should be performed on object property.", UnsupportedDecoratorExport: "A decorated export must export a class declaration.", UnsupportedDefaultExport: "Only expressions, functions or classes are allowed as the `default` export.", UnsupportedImport: "`import` can only be used in `import()` or `import.meta`.", UnsupportedMetaProperty: ({ target: a, onlyValidPropertyName: t }) => `The only valid meta property for ${a} is ${a}.${t}.`, UnsupportedParameterDecorator: "Decorators cannot be used to decorate parameters.", UnsupportedPropertyDecorator: "Decorators cannot be used to decorate object literal properties.", UnsupportedSuper: "'super' can only be used with function calls (i.e. super()) or in property accesses (i.e. super.prop or super[prop]).", UnterminatedComment: "Unterminated comment.", UnterminatedRegExp: "Unterminated regular expression.", UnterminatedString: "Unterminated string constant.", UnterminatedTemplate: "Unterminated template.", UsingDeclarationExport: "Using declaration cannot be exported.", UsingDeclarationHasBindingPattern: "Using declaration cannot have destructuring patterns.", VarRedeclaration: ({ identifierName: a }) => `Identifier '${a}' has already been declared.`, YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, Ys = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: ({ referenceName: a }) => `Assigning to '${a}' in strict mode.`, StrictEvalArgumentsBinding: ({ bindingName: a }) => `Binding '${a}' in strict mode.`, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, Qs = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), Zs = { PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: ({ token: a }) => `Invalid topic token ${a}. In order to use ${a} as a topic reference, the pipelineOperator plugin must be configured with { "proposal": "hack", "topicToken": "${a}" }.`, PipeTopicUnused: "Hack-style pipe body does not contain a topic reference; Hack-style pipes must use topic at least once.", PipeUnparenthesizedBody: ({ type: a }) => `Hack-style pipe body cannot be an unparenthesized ${Ee({ type: a })}; please wrap it in parentheses.`, PipelineBodyNoArrow: 'Unexpected arrow "=>" after pipeline body; arrow function in pipeline body must be parenthesized.', PipelineBodySequenceExpression: "Pipeline body may not be a comma-separated sequence expression.", PipelineHeadSequenceExpression: "Pipeline head should not be a comma-separated sequence expression.", PipelineTopicUnused: "Pipeline is in topic style but does not use topic reference.", PrimaryTopicNotAllowed: "Topic reference was used in a lexical context without topic binding.", PrimaryTopicRequiresSmartPipeline: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.' }, ei = ["toMessage"], ti = ["message"];
        ...
        function j(a, t) {
          ...
          for (let s of Object.keys(a)) {
            let i = a[s], r = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = r, o = Ht(r, ti), h = typeof n == "string" ? () => n : n;
            e[s] = si(Object.assign({ code: "BABEL_PARSER_SYNTAX_ERROR", reasonCode: s, toMessage: h }, t ? { syntaxPlugin: t } : {}, o));
          }
          return e;
        }
        var p = Object.assign({}, j(Xs), j(Gs), j(Ys), j`pipelineOperator`(Zs)), { defineProperty: ii } = Object, Ot = (a, t) => {
          a && ii(a, t, { enumerable: false, value: a[t] });
        };
        function oe(a) {
          return Ot(a.loc.start, "index"), Ot(a.loc.end, "index"), a;
        }
        var ri = (a) => class extends a {
          parse() {
        ...
        var b = true, m = true, $e = true, he = true, q = true, ai = true, ve = class {
          constructor(t, e = {}) {
        ...
        var gt = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-ࢎࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೝೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲈᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꟊꟐꟑꟓꟕ-ꟙꟲ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ", Jt = "‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛࢘-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‌‍‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯・꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿･", xi = new RegExp("[" + gt + "]"), Pi = new RegExp("[" + gt + Jt + "]");
        gt = Jt = null;
        ...
        function _(a) {
          return a < 65 ? a === 36 : a <= 90 ? true : a < 97 ? a === 95 : a <= 122 ? true : a <= 65535 ? a >= 170 && xi.test(String.fromCharCode(a)) : We(a, Xt);
        }
        function Q(a) {
          return a < 48 ? a === 36 : a < 58 ? true : a < 65 ? false : a <= 90 ? true : a < 97 ? a === 95 : a <= 122 ? true : a <= 65535 ? a >= 170 && Pi.test(String.fromCharCode(a)) : We(a, Xt) || We(a, gi);
        }
        var Tt = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, Ti = new Set(Tt.keyword), bi = new Set(Tt.strict), Ai = new Set(Tt.strictBind);
        function Gt(a, t) {
          return t && a === "await" || a === "enum";
        }
        function Yt(a, t) {
          return Gt(a, t) || bi.has(a);
        }
        function Qt(a) {
          return Ai.has(a);
        }
        ...
        function Ut(a, t, e, s, i, r) {
          ...
          for (; ; ) {
            ...
            if (d === 92) {
              c += t.slice(u, e);
              let y = Li(t, e, s, i, a === "template", r);
              y.ch === null && !l ? l = { pos: e, lineStart: s, curLine: i } : c += y.ch, { pos: e, lineStart: s, curLine: i } = y, u = e;
            } else d === 8232 || d === 8233 ? (++e, ++i, s = e) : d === 10 || d === 13 ? a === "template" ? (c += t.slice(u, e) + `
...
`);
            ...
            case 120: {
              let c;
              return { code: c, pos: t } = Ze(a, t, e, s, 2, false, n, r), o(c === null ? null : String.fromCharCode(c));
            }
            case 117: {
              let c;
              return { code: c, pos: t } = is(a, t, e, s, n, r), o(c === null ? null : String.fromCodePoint(c));
            }
            case 116:
              return o("	");
            case 98:
        ...
        function Ze(a, t, e, s, i, r, n, o) {
          let h = t, c;
          return { n: c, pos: t } = ss(a, t, e, s, 16, i, r, false, o, !n), c === null && (n ? o.invalidEscapeSequence(h, e, s) : t = h - 1), { code: c, pos: t };
        }
        function ss(a, t, e, s, i, r, n, o, h, c) {
          let l = t, u = i === 16 ? Rt.hex : Rt.decBinOct, f = i === 16 ? Ce.hex : i === 10 ? Ce.dec : i === 8 ? Ce.oct : Ce.bin, d = false, y = 0;
          for (let E = 0, L = r ?? 1 / 0; E < L; ++E) {
            ...
            if (S >= 97 ? I = S - 97 + 10 : S >= 65 ? I = S - 65 + 10 : ki(S) ? I = S - 48 : I = 1 / 0, I >= i) {
          ...
          return t === l || r != null && t - l !== r || d ? { n: null, pos: t } : { n: y, pos: t };
        }
        function is(a, t, e, s, i, r) {
          let n = a.charCodeAt(t), o;
          if (n === 123) {
            if (++t, { code: o, pos: t } = Ze(a, t, e, s, a.indexOf("}", t) - t, true, i, r), ++t, o !== null && o > 1114111) if (i) r.invalidCodePoint(t, e, s);
            else return { code: null, pos: t };
          } else ({ code: o, pos: t } = Ze(a, t, e, s, 4, false, i, r));
          return { code: o, pos: t };
        }
        function ce(a, t, e) {
          return new F(e, a - t, a);
        }
        var Di = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          constructor(t) {
          ...
          constructor(t, e) {
            ...
            } }), this.state = new Qe(), this.state.init(t), this.input = e, this.length = e.length, this.comments = [], this.isLookahead = false;
          }
          pushToken(t) {
          ...
          nextTokenInLineStartSince(t) {
            return Ne.lastIndex = t, Ne.test(this.input) ? Ne.lastIndex : t;
          }
          ...
          readToken_numberSign() {
            ...
            } else _(e) ? (++this.state.pos, this.finishToken(138, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(138, this.readWord1())) : this.finishOp(27, 1);
          }
          readToken_dot() {
          ...
          readRegexp() {
            ...
            for (; ; ++r) {
              ...
              if (fe(c)) throw this.raise(p.UnterminatedRegExp, v(t, 1));
              if (s) s = false;
              else {
                if (c === 91) i = true;
            ...
            for (; r < this.length; ) {
              ...
              if (Di.has(c)) c === 118 ? o.includes("u") && this.raise(p.IncompatibleRegExpUVFlags, h()) : c === 117 && o.includes("v") && this.raise(p.IncompatibleRegExpUVFlags, h()), o.includes(l) && this.raise(p.DuplicateRegExpFlags, h());
              else if (Q(c) || c === 92) this.raise(p.MalformedRegExpFlags, h());
              else break;
              ++r, o += l;
            }
          ...
          readRadixNumber(t) {
            ...
            if (_(this.codePointAtPos(this.state.pos))) throw this.raise(p.NumberIdentifier, this.state.curPosition());
            if (s) {
          ...
          readWord1(t) {
            ...
            for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
              ...
              if (Q(r)) this.state.pos += r <= 65535 ? 1 : 2;
              else if (r === 92) {
                this.state.containsEsc = true, e += this.input.slice(i, this.state.pos);
                let n = this.state.curPosition(), o = this.state.pos === s ? _ : Q;
          ...
          checkKeywordEscapes() {
            ...
            Pt(t) && this.state.containsEsc && this.raise(p.InvalidEscapedReservedWord, this.state.startLoc, { reservedWord: K(t) });
          }
          raise(t, e, s = {}) {
        ...
        var at = class extends et {
          ...
          hasFollowingLineBreak() {
            return Bt.lastIndex = this.state.end, Bt.test(this.input);
          }
          isLineTerminator() {
        ...
        function $(a) {
          let { type: t, start: e, end: s, loc: i, range: r, extra: n, name: o } = a, h = Object.create(bt);
        ...
        var Vi = /\*?\s*@((?:no)?flow)\b/, qi = (a) => class extends a {
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), c = 9, l = true) : (this.expect(5), c = 8, l = false), h.exact = l; !this.match(c); ) {
              let d = false, y = null, E = null, L = this.startNode();
              if (r && this.isContextual(118)) {
                let I = this.lookahead();
                I.type !== 14 && I.type !== 17 && (this.next(), y = this.state.startLoc, e = false);
              }
              ...
              if (this.eat(0)) y != null && this.unexpected(y), this.eat(0) ? (S && this.unexpected(S.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(L, d))) : h.indexers.push(this.flowParseObjectTypeIndexer(L, d, S));
              else if (this.match(10) || this.match(47)) y != null && this.unexpected(y), S && this.unexpected(S.loc.start), h.callProperties.push(this.flowParseObjectTypeCallProperty(L, d));
              else {
                let I = "init";
                ...
                let Ae = this.flowParseObjectTypeProperty(L, d, y, S, I, i, n ?? !l);
          ...
          shouldParseExportDeclaration() {
            ...
            return Ft(e) || this.shouldParseEnums() && e === 126 ? !this.state.containsEsc : super.shouldParseExportDeclaration();
          }
          isExportDefaultSpecifier() {
            let { type: e } = this.state;
            return Ft(e) || this.shouldParseEnums() && e === 126 ? this.state.containsEsc : super.isExportDefaultSpecifier();
          }
          ...
          parseImportSpecifierLocal(e, s, i) {
            s.local = _t(e) ? this.flowParseRestrictedIdentifier(true, true) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i));
          }
          ...
          parseMaybeAssign(e, s) {
            ...
            if ((i = n) != null && i.error || this.match(47)) {
              ...
              let c, l = this.tryParse((f) => {
                ...
                let E = this.maybeUnwrapTypeCastExpression(y);
                return E.type !== "ArrowFunctionExpression" && f(), E.typeParameters = c, this.resetStartLocationFromNode(E, c), y;
              }, r), u = null;
          ...
          flowEnumBody(e, s) {
            ...
            switch (e.hasUnknownMembers = h, n) {
              ...
              default: {
                ...
                if (!u && !f && l >= d) {
                  for (let y of o.defaultedMembers) this.flowEnumErrorBooleanMemberNotInitialized(y.loc.start, { enumName: i, memberName: y.id.name });
                  return e.members = o.booleanMembers, this.expect(8), this.finishNode(e, "EnumBooleanBody");
                } else if (!l && !f && u >= d) {
                  for (let y of o.defaultedMembers) this.flowEnumErrorNumberMemberNotInitialized(y.loc.start, { enumName: i, memberName: y.id.name });
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          jsxParseIdentifier() {
            let e = this.startNode();
            return this.match(140) ? e.name = this.state.value : Pt(this.state.type) ? e.name = K(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
          }
          ...
          updateContext(e) {
            ...
            } else this.state.canStartJSXElement = hi(i);
          }
        }, ot = class extends de {
          constructor(...t) {
        ...
        }, Ki = (a, t) => hasOwnProperty.call(a, t) && a[t], as = (a) => a.type === "ParenthesizedExpression" ? as(a.expression) : a, lt = class extends nt {
          ...
          checkLVal(t, { in: e, binding: s = 64, checkClashes: i = false, strictModeChanged: r = false, hasParenthesizedAncestor: n = false }) {
            ...
            if (l === false) {
              ...
              this.raise(y, t, { ancestor: e });
              return;
            }
            let [u, f] = Array.isArray(l) ? l : [l, h === "ParenthesizedExpression"], d = h === "ArrayPattern" || h === "ObjectPattern" ? { type: h } : e;
            for (let y of [].concat(t[u])) y && this.checkLVal(y, { in: d, binding: s, checkClashes: i, strictModeChanged: r, hasParenthesizedAncestor: f });
          }
          checkIdentifier(t, e, s = false) {
            this.state.strict && (s ? Zt(t.name, this.inModule) : Qt(t.name)) && (e === 64 ? this.raise(p.StrictEvalArguments, t, { referenceName: t.name }) : this.raise(p.StrictEvalArgumentsBinding, t, { bindingName: t.name })), e & 8192 && t.name === "let" && this.raise(p.LetInLexicalBinding, t), e & 64 || this.declareNameFromIdentifier(t, e);
          }
        ...
        var Gi = (a) => class extends a {
          ...
          parseSubscript(e, s, i, r) {
            ...
            if (this.match(47) || this.match(51)) {
              let o, h = this.tsTryParseAndCatch(() => {
                ...
                if (l === 48 || l === 52 || l !== 10 && He(l) && !this.hasPrecedingLineBreak()) return;
          ...
          parseMaybeAssign(e, s) {
            ...
            if (this.hasPlugin("jsx") && (this.match(142) || this.match(47))) {
              ...
              let { context: y } = this.state, E = y[y.length - 1];
              (E === C.j_oTag || E === C.j_expr) && y.pop();
            }
            ...
            let f, d = this.tryParse((y) => {
              ...
              return (S.type !== "ArrowFunctionExpression" || (E = S.extra) != null && E.parenthesized) && y(), ((L = f) == null ? void 0 : L.params.length) !== 0 && this.resetStartLocationFromNode(S, f), S.typeParameters = f, S;
            }, c);
          ...
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            if (this.isContextual(93)) {
              ...
              if (this.isContextual(93)) {
                ...
                M(this.state.type) ? (c = true, o = d, h = s ? this.parseIdentifier() : this.parseModuleExportName(), l = false) : (h = y, l = false);
              } else M(this.state.type) ? (l = false, h = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = true, o = d);
        ...
        var Vt = j`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), er = (a) => class extends a {
          parsePlaceholder(e) {
            if (this.match(144)) {
              let s = this.startNode();
          ...
          parseClass(e, s, i) {
            ...
            if (o) if (this.match(81) || this.match(144) || this.match(5)) e.id = o;
              ...
              throw this.raise(Vt.ClassNameIsRequired, this.state.startLoc);
            }
          ...
          assertNoSpace() {
            this.state.start > this.state.lastTokEndLoc.index && this.raise(Vt.UnexpectedSpace, this.state.lastTokEndLoc);
          }
        ...
        var qt = ["minimal", "fsharp", "hack", "smart"], zt = ["^^", "@@", "^", "%", "#"];
        function sr(a) {
          if (N(a, "decorators")) {
        ...
        var ct = class extends lt {
          ...
          parseMaybeUnary(t, e) {
            ...
            if (i) {
              ...
              if ((this.hasPlugin("v8intrinsic") ? He(h) : He(h) && !this.match(54)) && !this.isAmbiguousAwait()) return this.raiseOverwrite(p.AwaitNotInAsyncContext, s), this.parseAwait(s);
            }
            return o;
          }
          parseUpdate(t, e, s) {
          ...
          parseSubscript(t, e, s, i) {
            ...
            if (Le(r)) return this.parseTaggedTemplateExpression(t, e, i);
            let n = false;
            if (r === 18) {
          ...
          parseCoverCallAndAsyncArrowHead(t, e, s, i) {
            ...
            h && (this.expressionScope.enter(Fi()), n = new Z()), c && (o.optional = i), i ? o.arguments = this.parseCallExpressionArguments(11) : o.arguments = this.parseCallExpressionArguments(11, t.type === "Import", t.type !== "Super", o, n);
          ...
          parseExprAtom(t) {
            ...
            switch (i) {
              ...
              case 47: {
                ...
                _(r) || r === 62 ? this.expectOnePlugin(["jsx", "flow", "typescript"]) : this.unexpected();
                break;
              }
              default:
                if (w(i)) {
          ...
          parseAsyncArrowUnaryFunction(t) {
            this.prodParam.enter(ke(true, this.prodParam.hasYield));
            let e = [this.parseIdentifier()];
          ...
          parseParenAndDistinguishExpression(t) {
            ...
            for (; !this.match(11); ) {
              ...
              if (this.match(21)) {
                ...
                if (l = this.state.startLoc, o.push(this.parseParenItem(this.parseRestBinding(), y)), !this.checkCommaAfterRest(41)) break;
...
`), cooked: r === null ? null : r.slice(1, c) }, o.tail = h, this.next();
            ...
            return this.resetEndLocation(u, v(this.state.lastTokEndLoc, c)), u;
          }
          parseTemplate(t) {
          ...
          parseMethod(t, e, s, i, r, n, o = false) {
            this.initFunction(t, s), t.generator = e, this.scope.enter(18 | (o ? 64 : 0) | (r ? 32 : 0)), this.prodParam.enter(ke(s, t.generator)), this.parseFunctionParams(t, i);
          ...
          checkReservedWord(t, e, s, i) {
            ...
            if ((this.state.strict ? i ? Zt : Yt : Gt)(t, this.inModule)) {
          ...
          isAmbiguousAwait() {
            ...
            let { type: t } = this.state;
            return t === 53 || t === 10 || t === 0 || Le(t) || t === 102 && !this.state.containsEsc || t === 137 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
          }
          parseYield() {
            let t = this.startNode();
        ...
        }, ze = { kind: 1 }, ar = { kind: 2 }, nr = /[\uD800-\uDFFF]/u, Ke = /in(?:stanceof)?/y;
        function or(a, t) {
          for (let e = 0; e < a.length; e++) {
            ...
            if (typeof i == "number") {
              {
                if (i === 138) {
                  let { loc: r, start: n, value: o, end: h } = s, c = n + 1, l = v(r.start, 1);
                ...
                if (Le(i)) {
                  let { loc: r, start: n, value: o, end: h } = s, c = n + 1, l = v(r.start, 1), u;
                  ...
                  let f, d, y, E;
                  i === 24 ? (d = h - 1, y = v(r.end, -1), f = o === null ? null : o.slice(1, -1), E = new O({ type: R(22), value: "`", start: d, end: h, startLoc: y, endLoc: r.end })) : (d = h - 2, y = v(r.end, -2), f = o === null ? null : o.slice(1, -2), E = new O({ type: R(23), value: "${", start: d, end: h, startLoc: y, endLoc: r.end })), a.splice(e, 1, u, new O({ type: R(20), value: f, start: c, end: d, startLoc: l, endLoc: y }), E), e += 2;
                  continue;
                }
              }
              s.type = R(i);
        ...
        var pt = class extends ct {
          parseTopLevel(t, e) {
            return t.program = this.parseProgram(e), t.comments = this.comments, this.options.tokens && (t.tokens = or(this.tokens, this.input)), this.finishNode(t, "File");
          }
          ...
          chStartsBindingIdentifier(t, e) {
            if (_(t)) {
              if (Ke.lastIndex = e, Ke.test(this.input)) {
                let s = this.codePointAtPos(Ke.lastIndex);
                if (!Q(s) && s !== 92) return false;
              }
              return true;
            } else return t === 92;
          }
          ...
          parseForStatement(t) {
            ...
            let s = this.isContextual(100);
            {
              ...
              if (this.match(74) || this.match(75) || l) {
                ...
                return y && c && this.raise(p.ForInUsing, d), (y || this.isContextual(102)) && d.declarations.length === 1 ? this.parseForIn(t, d, e) : (e !== null && this.unexpected(e), this.parseFor(t, d));
              }
            }
          ...
          parseSwitchStatement(t) {
            ...
            let e = t.cases = [];
            this.expect(5), this.state.labels.push(ar), this.scope.enter(0);
            let s;
          ...
          parseLabeledStatement(t, e, s, i) {
            ...
            let r = ci(this.state.type) ? 1 : this.match(71) ? 2 : null;
          ...
          parseFunction(t, e = 0) {
            ...
            return this.state.maybeInArrowParameters = false, this.scope.enter(2), this.prodParam.enter(ke(n, t.generator)), i || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, false), this.withSmartMixTopicForbiddingContext(() => {
          ...
          parseClassMemberWithIsStatic(t, e, s, i) {
            ...
            let f = !this.state.containsEsc && w(this.state.type), d = this.parseClassElementName(e), y = f ? d.name : null, E = this.isPrivateName(d), L = this.state.startLoc;
            if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
              ...
              this.resetPreviousNodeTrailingComments(d), l.kind = y;
              let S = this.match(138);
          ...
          parseModuleExportName() {
            if (this.match(133)) {
              let t = this.parseStringLiteral(this.state.value), e = nr.exec(t.value);
          ...
          constructor(t, e) {
            t = rr(t), super(t, e), this.options = t, this.initializeScopes(), this.plugins = hr(this.options.plugins), this.filename = t.sourceFilename;
          }
          getScopeHandler() {
            return me;
          }
        ...
        function pe(a, t) {
          let e = Me;
          return a != null && a.plugins && (sr(a.plugins), e = fr(a.plugins)), new e(a, t);
        }
        var Kt = {};
        function fr(a) {
          let t = ir.filter((i) => N(a, i)), e = t.join("/"), s = Kt[e];
          if (!s) {
            s = Me;
      ...
      var ha = Oe(/\s/u), ls = Oe(" 	"), la = Oe(",; 	"), cs = Oe(/[^\n\r]/u);
      function dr(a, t) {
...
`);
      ...
      var ys = Ar;
      var Sr = ys(["Block", "CommentBlock", "MultiLine"]), ge = Sr;
      function wr(a) {
        let t = `*${a.value}*`.split(`
`);
      ...
      function be(a) {
        if (Te !== null && typeof Te.property) {
          let t = Te;
          return Te = be.prototype = null, t;
        }
        return Te = be.prototype = a ?? /* @__PURE__ */ Object.create(null), new be();
      }
      var Er = 10;
      for (let a = 0; a <= Er; a++) be();
      function Ct(a) {
        return be(a);
      }
      function Ir(a, t = "type") {
        Ct(a);
        function e(s) {
          let i = s[t], r = a[i];
      ...
      function Et(a, t) {
        ...
        if (Array.isArray(a)) {
          for (let s = 0; s < a.length; s++) a[s] = Et(a[s], t);
          return a;
        }
        let e = Ts(a);
        for (let s = 0; s < e.length; s++) a[e[s]] = Et(a[e[s]], t);
        return t(a) || a;
      }
      var Be = Et;
      function kr(a, t) {
        ...
        if (a = Be(a, (i) => {
          ...
          switch (i.type) {
            ...
            case "VariableDeclaration": {
              let n = St(false, i.declarations, -1);
      ...
      function It(a) {
        return bs(a) ? It({ type: "LogicalExpression", operator: a.operator, left: It({ type: "LogicalExpression", operator: a.operator, left: a.left, right: a.right.left, range: [D(a.left), B(a.right.left)] }), right: a.right.right, range: [D(a), B(a)] }) : a;
      }
      var As = kr;
      function vr(a, t) {
      ...
      function Es(a) {
        let t = `
`;
        a = ie(false, a.replace(Or, "").replace(Mr, ""), Ur, "$1");
        let e = "";
        for (; e !== a; ) e = a, a = ie(false, a, Rr, `${t}$1 $2${t}`);
        a = a.replace(Ss, "").trimEnd();
        let s = /* @__PURE__ */ Object.create(null), i = ie(false, a, ws, "").replace(Ss, "").trimEnd(), r;
        for (; r = ws.exec(a); ) {
          let n = ie(false, r[2], Br, "");
          if (typeof s[r[1]] == "string" || Array.isArray(s[r[1]])) {
            let o = s[r[1]];
            s[r[1]] = [..._r, ...Array.isArray(o) ? o : [o], n];
          } else s[r[1]] = n;
        }
      ...
      function $r(a) {
        return a = typeof a == "function" ? { parse: a } : a, { astFormat: "estree", hasPragma: Is, locStart: D, locEnd: B, ...a };
      }
      var G = $r;
      function Vr(a) {
        let { filepath: t } = a;
      ...
      function Hr(a, t) {
        ...
        let s = ds(a, 0);
        return s !== false && (a = a.slice(0, s)), Kr.test(a);
      }
      function Wr(a, t, e) {
      ...
      function Jr({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          if ((s.parser === "babel" || s.parser === "__babel_estree") && Hr(e, s)) return s.parser = "babel-flow", Bs.parse(e, s);
          let i = t;
          (s.__babelSourceType ?? Ns(s)) === "script" && (i = i.map((c) => ({ ...c, sourceType: "script" })));
          let n = /%[A-Z]/u.test(e);
          e.includes("|>") ? i = (n ? [...vs, ks] : vs).flatMap((l) => i.map((u) => V([l], u))) : n && (i = i.map((c) => V([ks], c)));
          let o = a ? je.parseExpression : je.parse, h;
          try {
            h = ms(i.map((c) => () => Wr(o, e, c)));
          } catch ({ errors: [c] }) {
            throw Ue(c);
          }
          return a && (h = _e(h, { text: e, rootMarker: s.rootMarker })), As(h, { parser: "babel", text: e });
        };
      }
      var Xr = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "ForInOfLoopInitializer", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), Fs = [V(["jsx"])], Ls = re({ optionsCombinations: Fs }), Ds = re({ optionsCombinations: [V(["jsx", "typescript"]), V(["typescript"])] }), Ms = re({ isExpression: true, optionsCombinations: [V(["jsx"])] }), Os = re({ isExpression: true, optionsCombinations: [V(["typescript"])] }), Bs = re({ optionsCombinations: [V(["jsx", ["flow", { all: true, enums: true }], "flowComments"])] }), Gr = re({ optionsCombinations: Fs.map((a) => V(["estree"], a)) }), Rs = { babel: Ls, "babel-flow": Bs, "babel-ts": Ds, __js_expression: Ms, __ts_expression: Os, __vue_expression: Ms, __vue_ts_expression: Os, __vue_event_binding: Ls, __vue_ts_event_binding: Ds, __babel_estree: Gr };
      var Us = vt(At(), 1);
      function _s(a = {}) {
        ...
        return function(s) {
          ...
          return ae(i), _e(i, { type: "JsonRoot", text: s });
        };
      }
      function H(a, t) {
      ...
      var Nt = _s(), Yr = { json: G({ parse: Nt, hasPragma() {
        return true;
      } }), json5: G(Nt), jsonc: G(Nt), "json-stringify": G({ parse: _s({ allowComments: false }), astFormat: "estree-json" }) }, js = Yr;
      var Qr = { ...Rs, ...js };
      return Js(Zr);
    });
  }
