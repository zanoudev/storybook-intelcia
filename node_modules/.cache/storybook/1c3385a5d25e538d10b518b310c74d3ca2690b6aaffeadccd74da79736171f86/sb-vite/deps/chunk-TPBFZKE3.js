...
var gn = l((dg, Tn) => {
  ...
  function xu(e, n) {
    var a = yu(e), s = !a && fu(e), p = !a && !s && du(e), c = !a && !s && !p && Tu(e), y = a || s || p || c, d = y ? lu(e.length, String) : [], m = d.length;
    for (var g in e)
...
var St = l((Kh, Vo) => {
  ...
  function Jf(e, n, a, s, p, c) {
    ...
    if (g && b)
      return g == n && b == e;
    var A = -1, J = true, v = a & Pf ? new xf() : void 0;
...
var Da = l((mx, _a) => {
  var Ot = ga(), At = Ve(), Nt = xa(), _t = va(), Dt = Pa(), Na = ne(), le = gt(), Ja = "[object Map]", Jy = "[object Object]", Sa = "[object Promise]", Ea = "[object Set]", Oa = "[object WeakMap]", Aa = "[object DataView]", Sy = le(Ot), Ey = le(At), Oy = le(Nt), Ay = le(_t), Ny = le(
    Dt
  ), X = Na;
    ...
    function De({ allowSquareBracketsOnAnyType: t, allowJsdocNamePaths: o, pathGrammar: i }) {
      return r(function(f, T, x) {
        ...
        if (!(S === "." && D !== "<" || S === "[" && (t || x.type === "JsdocTypeName") || o && (S === "~" || S === "#")))
          return null;
        let j, Le = false;
        f.consume(".") ? j = "property" : f.consume("[") ? (j = "property-brackets", Le = true) : f.consume("~") ? j = "inner" : (f.consume("#"), j = "instance");
...
//# sourceMappingURL=chunk-TPBFZKE3.js.map
